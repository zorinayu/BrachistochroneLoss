...
class CIFAR10Dataset(torch.utils.data.Dataset):
    def __init__(self, data_path='data/cifar-10-python.tar.gz', sample_size=None, test_size=0.2, random_state=42):
        ...
        # Load training data
        train_files = ['data/cifar-10-batches-py/data_batch_1', 'data/cifar-10-batches-py/data_batch_2']
        all_data = []
        all_labels = []
